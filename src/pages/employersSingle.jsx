                            ...
                            <div className="col-lg-12">
                                <div className="wd-job-author stc-em">
                                    <div className="inner-job-left">
                                        <img src="images/logo-company/cty4.png" alt="images/logo-company/cty4.png" className="logo-company" />
                                        <div className="content">
                                            <h3><a href="#">Avitex Agency</a><span className="icon-bolt"></span></h3>
                                    ...
                                    <div className="content-tab">
                                        <div className="inner-content">
                                            ...
                                            <div className="post-navigation d-flex aln-center">
                                                ...
                                                <a href="#" className="frag-btn"> <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15"
                                            ...
                                            <div className="video-thumb">
                                                ...
                                                <ul className="thumb-menu menu-tab2">
                                                    <li className="ct-tab2"> <a className="lightbox-gallery" href="images/review/thumbv4.jpg"><img
                                                        src="images/review/thumbv4.jpg" alt="images" /></a> </li>
                                                    <li className="ct-tab2"> <a className="lightbox-gallery" href="images/review/thumbv1.jpg"><img
                                                        src="images/review/thumbv1.jpg" alt="images" /></a></li>
                                                    <li className="ct-tab2"><a className="lightbox-gallery" href="images/review/thumbv2.jpg"><img
                                            ...
                                            <div className="job-rating">
                                                        ...
                                                        <div className="content">
                                                            <div className="top-content">
                                                                <div className="avatar">
                                                                    <div className="avt">
                                                                        <img src="images/user/avatar/img-5.jpg" alt="images" />
                                                                    </div>
                                                                    <div className="infor">
                                                                        <h5><a href="#">Ariel Houessou</a><svg xmlns="http://www.w3.org/2000/svg" width="21"
                                                            ...
                                                            <a href="#" className="btn-like">Was this helpful? <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <li className="client-item">
                                                        <div className="content">
                                                            <div className="top-content">
                                                                <div className="avatar">
                                                                    <div className="avt">
                                                                        <img src="images/user/avatar/image-04.jpg" alt="images" />
                                                                    </div>
                                                                    <div className="infor">
                                                                        <h5><a href="#">Antony Bessan</a><svg xmlns="http://www.w3.org/2000/svg" width="21"
                                                                            height="20" viewBox="0 0 21 20" fill="none">
                                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                                                d="M0.5 10C0.5 4.47715 4.97715 0 10.5 0C16.0228 0 20.5 4.47715 20.5 10C20.5 15.5228 16.0228 20 10.5 20C4.97715 20 0.5 15.5228 0.5 10Z"
                                                                                fill="#37B853" />
                                                        ...
                                                        <div className="content">
                                                            <div className="top-content">
                                                                <div className="avatar">
                                                                    ...
                                                                    <div className="infor">
                                                                        <h5><a href="#">Jean Paul Sessou</a><svg xmlns="http://www.w3.org/2000/svg" width="21"
                                                                            height="20" viewBox="0 0 21 20" fill="none">
                                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                                                d="M0.5 10C0.5 4.47715 4.97715 0 10.5 0C16.0228 0 20.5 4.47715 20.5 10C20.5 15.5228 16.0228 20 10.5 20C4.97715 20 0.5 15.5228 0.5 10Z"
                                                                                fill="#37B853" />
                                                ...
                                                <a href="employers-list.html" className="btn-load">See more reviews (719)</a>
                                            </div>
