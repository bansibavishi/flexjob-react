    ...
    return (
        <>
            ...
            <div className="boxed">
                ...
                <section className="tf-tab inner-review-section-two">
                    ...
                    <div className="tf-container">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-md-12 content-tab">
                                <div className="wd-review-job contentbox1 stc3">
                                    ...
                                    <p>Search millions of jobs and get the inside scoop on companies with employee reviews, personalized salary
                                        tools, and more.</p>
                                    <ul className="wd-list-icon wow fadeInRight">
                ...
                <section className="inner-testimonials-section">
                    <div className="wrap-testimonials over-flow-hidden stc">
                        <div className="tf-container">
                            <div className="row">
                                <div className="col-lg-12">
                                ...
                                <div className="col-lg-12 wow fadeInUp">
                                    <div className="swiper-container tes-slider stc">
                ...
                {/* <section>
                    <div className="wd-partner style-1">
                        <div className="tf-container">
                            ...
                            <div className="swiper partner-type-7">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
